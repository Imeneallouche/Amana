      ...
      <Sidebar.Items className="!border-none">
        <Sidebar.ItemGroup className="!border-none">
          ...
          <div>
            ...
            {isTransactionsOpen && (
              <div className="ml-6">
                ...
                <Sidebar.Item
                  to="/transactionsVolunteer/achieved"
                  className={`${getItemClass("/transactionsVolunteer/achieved")} flex items-center lg:gap-[10%] my-2`}
                >
                  Achieved
                </Sidebar.Item>
              </div>
          ...
          <Sidebar.Item
            ...
            icon={() => <MedalStar size="20" variant="Bold" color={location.pathname === "/achievements" ? "#C1B49A" : "#96A9A2"} />}
          >
            Achievements
          </Sidebar.Item>
